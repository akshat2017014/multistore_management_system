...
/**
 * It a controller class 
 * Controls the superstore fxml file
 * @author yatinarora
 *
 */
public class SuperstoreController {
	...
	/**
	 * exits the program on clicking exit
	 * @param event
	 */
...
//		l1.setText(houseid+name+adminname+adminId+pass);
	...
	/**
	 * Creates super store on button click
	 */
	...
	public void shows_stores_warehouses() {
		lw.getItems().clear();
		lw.getItems().addAll(system1.superstore.getWarehousees());
		ls.getItems().clear();
		ls.getItems().addAll(system1.superstore.getStorehouses());
	...
	public void search_storehouse(ActionEvent event) {
try {
        	
        	
        	
        	FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("search_in_storehouses.fxml"));
                Parent root1 = (Parent) fxmlLoader.load();
                Stage stage = new Stage();
                stage.close();
                stage.setScene(new Scene(root1));  
	...
	public void search_warehouse(ActionEvent event) {
try {
        	
        	
        	
        	FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("search_in_warehouses.fxml"));
                Parent root1 = (Parent) fxmlLoader.load();
                Stage stage = new Stage();
                stage.close();
                stage.setScene(new Scene(root1));  
